...
This directory contains internationalization (i18n) files for the advertising module in Hugo. In Hugo, i18n files are used to store translations for your site.
